...
# Reading the file
f1 = './scores/scores1.txt'
f1_out = './scores/extracted_scores_1.xlsx'

f2 = './scores/scores2.txt'
f2_out = './scores/extracted_scores_2.xlsx'

f3 = './scores/scores3.txt'
f3_out = './scores/extracted_scores_3.xlsx'

l1 = './scores/lscores1.txt'
l1_out = './scores/extracted_lscores_1.xlsx'

l2 = './scores/lscores2.txt'
l2_out = './scores/extracted_lscores_2.xlsx'

l3 = './scores/lscores3.txt'
l3_out = './scores/extracted_lscores_3.xlsx'
...
def extract_lscores(filename, output_filename):
    ...
    title = None
    precision_tr = recall_tr = precision_luhn = recall_luhn = None
    ...
    for line in file_content:
        if line.startswith('pdfs\\') or line.startswith('pdfs2\\') or line.startswith('pdfs3\\'):  # Filename line
            ...
            if title is not None:
                data.append([title, precision_tr, recall_tr, precision_luhn, recall_luhn])
    ...
    columns = ['Title', 'Precision (TextRank)', 'Recall (TextRank)', 'Precision (Luhn)', 'Recall (Luhn)']
